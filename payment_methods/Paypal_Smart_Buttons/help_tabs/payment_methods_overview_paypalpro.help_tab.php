<p><strong><?php _e('PayPal Smart Buttons', 'event_espresso'); ?></strong></p>
<p>
...
<p>
    <?php
    printf(
        __('See %1$shere%2$s for list of currencies supported by PayPal Smart Buttons (which uses PayPal\'s REST API).', 'event_espresso'),
...
<ul>
    <li>
        <strong><?php _e('App Client ID', 'event_espresso'); ?></strong><br/>
        <?php _e('Retrieved from PayPal\'s "My Apps & Credentials" page, see above.', 'event_espresso'); ?>
    </li>
    <li>
        <strong><?php _e('App Secret', 'event_espresso'); ?></strong><br/>
        <?php _e('Retrieved from PayPal\'s "My Apps & Credentials" page, see above.', 'event_espresso'); ?>
    </li>
    <li>
        <strong><?php _e('Button Shape', 'event_espresso'); ?></strong><br/>
        <?php _e('Controls the shape of PayPal\'s Smart Buttons. Choose whichever shape you prefer with your website\'s design.', 'event_espresso'); ?>
    </li>
    <li>
        <strong><?php _e('Button Size', 'event_espresso'); ?></strong><br/>
        <?php _e(
